...
<?php $__env->startSection('body-class', 'bg-service'); ?>
    ...
    <div class="py-4 text-white"> <h2 class="fw-bold border-bottom pb-2">LAYANAN DAN KEMAMPUAN</h2>
        <p class="text-light">Bidang mekatronika yang saya kuasai:</p> <div class="row mt-4">
            <div class="col-md-6 mb-5">
                ...
                <img src="<?php echo e(asset('img/2.jpg')); ?>" alt="Skill 90%" class="img-fluid mt-2 rounded" style="max-width: 350px;">
            </div>
            ...
            <div class="col-md-6 mb-5">
                ...
                <img src="<?php echo e(asset('img/3.jpg')); ?>" alt="Skill 75%" class="img-fluid mt-2 rounded" style="max-width: 350px;">
            </div>
            ...
            <div class="col-md-6 mb-5">
                ...
                <img src="<?php echo e(asset('img/4.jpg')); ?>" alt="Skill 60%" class="img-fluid mt-2 rounded" style="max-width: 350px;">
            </div>
            ...
            <div class="col-md-6 mb-5">
                ...
                <img src="<?php echo e(asset('img/5.jpg')); ?>" alt="Skill 55%" class="img-fluid mt-2 rounded" style="max-width: 350px;">
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\bagashartanto.20236004\WEB_LARAVEL\todo-app\resources\views/service.blade.php ENDPATH**/ ?>